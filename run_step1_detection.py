...
SEED_PATH = r"D:\Math_match\codes\outputs\step1_detection_seed_20_eastmoney400.json"
OUTPUT_PATH = r"D:\Math_match\codes\outputs\step1_detection_semisupervised_eastmoney400.json"
...
def main() -> int:
    ...
    payload = runner.run(input_path=INPUT_PATH, output_path=OUTPUT_PATH, seed_path=SEED_PATH)
